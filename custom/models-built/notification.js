...
var Notification = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], Notification.prototype, "source_url");
    __decorate([
        TypeORM.Column({ nullable: true, type: "integer" }),
        __metadata("design:type", Number)
    ], Notification.prototype, "source_id");
    __decorate([
        TypeORM.Column({ nullable: true, type: "integer" }),
        __metadata("design:type", Number)
    ], Notification.prototype, "actor_id");
    __decorate([
    ...
    __decorate([
        TypeORM.Column({ nullable: true, type: "integer" }),
        __metadata("design:type", Number)
    ], Notification.prototype, "read_at");
    Notification = __decorate([
        TypeORM.Entity({ name: "notification" })
    ], Notification);
    return Notification;
}(common_1["default"]));
